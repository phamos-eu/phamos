// frappe.provide('erpnext.utils'); // Ensure the namespace exists
...
//                     },
//                     // Third Column - Placeholder for future API integration
//                     {
//                         fieldname: 'section_break_3',
//                         fieldtype: 'Section Break'
//                     },
//                     {
//                         fieldname: 'available_slots_section',
//                         fieldtype: 'Section Break',
...
//                         fieldtype: 'HTML',
//                         // This will be populated later with API data
//                         options: `<div class="available-slots">API integration for Mailcow Sogo slots will go here.</div>`
//                     }
//                 ],
//                 primary_action: function(values) {
//                     // Your logic to handle the form submission goes here
//                     console.log('Event details:', values);
//                     frappe.show_alert({ message: __('Event created successfully'), indicator: 'green' });
//                     custom_dialog.hide();
//                     // You can add a frappe.call here to save the document
//                 },
...
//             // Then adjust its width to 70% of the viewport
//             // custom_dialog.$wrapper.find('.modal-dialog').css('width', '70vw');
//             custom_dialog.$wrapper.find('.modal-dialog').css({
//                 'width': '70vw',
//                 'max-width': '70vw' // Prevents it from being limited by a max-width
//             });
//         };
...
//         let me = this;
//         let _create_event = () => {
//             // Create custom dialog with proper field structure for InteractionComposer
//             let custom_dialog = new frappe.ui.Dialog({
//                 title: __('New Event'),
//                 fields: [
//                     {
...
//                         fieldname: 'available_slots_html',
//                         fieldtype: 'HTML',
//                         options: `<div class="available-slots" style="padding: 10px; background: #fafafa; border-radius: 3px; text-align: center;">
//                                     <span class="text-muted">${__('Mailcow Sogo integration will appear here')}</span>
//                                   </div>`
//                     }
//                 ],
//                 primary_action: function(values) {
//                     // Create the event using the original InteractionComposer logic
//                     const args = {
//                         doc: me.frm.doc,
//                         frm: me.frm,
//                         title: __("New Event"),
...
//                     console.log('Composer dialog fields:', composer.dialog.fields);
                    
                    
                    
//                     // Set the values from our custom dialog to the composer
//                     composer.dialog.set_values({
//                         subject: values.subject,
//                         description: values.description,
//                         // Map our custom fields to the composer's expected fields
//                         starts_on: values.starts_on,
//                         ends_on: values.ends_on
//                     });
                    
//                     // Hide the interaction type field as in original
//                     $(composer.dialog.get_field('interaction_type').wrapper).hide();
                    
//                     // Set the composer's primary action to handle the save
//                     composer.primary_action = function() {
//                         // Get final values from composer dialog
//                         let composer_values = composer.dialog.get_values();
                        
//                         // Ensure our custom end date is included
//                         if (values.ends_on) {
//                             composer_values.ends_on = values.ends_on;
//                         }
...
//                                     me.refresh(); // Refresh the activities section
                                    
//                                     // Also refresh the form to show new event in timeline
//                                     if (me.frm) {
//                                         me.frm.refresh();
//                                     }
//                                 }
...
//                     // Programmatically trigger the composer's save action
//                     composer.primary_action();
//                 },
//                 primary_action_label: __('Create')
//             });

//             // Set default end date (start date + 1 hour)
//             // custom_dialog.set_values({
//             //     starts_on: frappe.datetime.now_datetime(),
//             //     ends_on: frappe.datetime.add_hours(frappe.datetime.now_datetime(), 1)
//             // });
...
//                         const v = custom_dialog.get_values();
//                         if (!v) return;
...
//                             callback: function(r) {
//                                 if (!r.exc && r.message) {
//                                     // Call function to display the slots in the container
//                                     console.log('[Mailcow] Free slots response:', r.message);
                                    
//                                     me.displaySlots(r.message, slotsContainer);
//                                 } else {
//                                     slotsContainer.html('<div class="text-muted text-center">No slots available or failed to fetch.</div>');
//                                 }
//                             }
//                         });
//                     }
...
//                         ref_type: me.frm.doc.doctype,
//                         ref_name: me.frm.doc.name
//                     };
...
//         // Create HTML for slots. Assuming each slot is an object with a 'time' property.
//         let slotsHTML = slots.map(slot => 
//             `<div class="slot-item" style="display: inline-block; margin: 5px; padding: 10px 15px; background: #f0f7ff; border: 1px solid #c2d9ff; border-radius: 4px; white-space: nowrap;">
//                 <span>${slot.start_local} - ${slot.end_local}</span>
//             </div>`
//         ).join('');

//         // Wrap the slots in a scrollable div and update the container
//         container.html(`
//             <div class="slots-scroll-wrapper" style="width: 100%; overflow-x: auto; white-space: nowrap; padding: 5px 0;">
//                 ${slotsHTML}
//             </div>
//         `);
//     }
