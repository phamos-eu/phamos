				...
				<div class="flex flex-1 flex-col items-center justify-center gap-2 px-6 text-center">
					<template v-if="view === 'assigned'">
						...
						<p class="max-w-sm text-sm text-gray-500 dark:text-gray-400">
							When someone assigns an HR issue to you, it will show up here.
						</p>
					</template>
					<template v-else>
						<p class="font-medium text-gray-900 dark:text-gray-100">You have not created any issues yet</p>
						<p class="max-w-sm text-sm text-gray-500 dark:text-gray-400">
							Capture an HR topic or follow-up with New Issue.
						</p>
...
import HrCreateIssueDialog from "../components/HrCreateIssueDialog.vue"

const API = "phamos.api.hr_spa"
const LAYOUT_KEY = "hr-spa-issues-layout"
const tabs = [
