<template>
	...
	>
		...
		>
			<span v-if="!collapsed" class="truncate text-sm font-semibold text-gray-900 dark:text-gray-100">Accounting</span>
			<button
				type="button"
...
const STORAGE_KEY = "accounting-spa-sidebar-collapsed"
